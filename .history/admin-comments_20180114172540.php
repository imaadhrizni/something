			...
			<article>
				...
				<div style="margin-top: 100px;">
					...
					if(isset($_POST['approve'])){
						...
						$sqlApprove = "UPDATE `comment` SET `comment_id`=[value-1],`comment_text`=[value-2],`comment_approve_status`=[value-3],`comment_user_name`=[value-4],`comment_article_id`=[value-5] WHERE 1;
